...
CREATE TABLE `tbkurir` (
  ...
  `JNT Expres` int(11) NOT NULL,
  `POS Indonesia` int(11) NOT NULL,
  `JNE` int(11) NOT NULL,
...
INSERT INTO `tbkurir` (`id_kurir`, `provinsi`, `JNT Expres`, `POS Indonesia`, `JNE`, `SiCepat`) VALUES
(1, 'Aceh', 67000, 52000, 66000, 84000),
(2, 'Sumatra Utara', 47000, 37000, 43000, 50000),
(3, 'Sumatra Selatan', 37000, 30000, 35000, 40000),
(4, 'Sumatra Barat', 41000, 37000, 40000, 43000),
(5, 'Bengkulu', 40000, 34000, 41000, 43000),
(6, 'Riau', 39000, 35000, 40000, 43000),
(7, 'Kepulauan Riau', 36000, 32000, 34000, 38000),
(8, 'Jambi', 32000, 29000, 33000, 35000),
(9, 'Lampung', 34000, 30000, 32000, 35000),
(10, 'Bangka Belitung', 32000, 30000, 32000, 34000),
(11, 'Banten', 25000, 24000, 27000, 30000),
(12, 'DKI Jakarta', 24000, 20000, 21000, 26000),
(13, 'Jawa Barat', 19000, 16000, 17000, 19000),
(14, 'Jawa Tengah', 11000, 7000, 9000, 12000),
(15, 'DI Yogyakarta', 16000, 13000, 14000, 15000),
(16, 'Jawa Timur', 18000, 15000, 19000, 19000),
(17, 'Kalimantan Timur', 52000, 49000, 53000, 54000),
(18, 'Kalimantan Barat', 51000, 50000, 53000, 55000),
(19, 'Kalimantan Tengah', 54000, 50000, 55000, 57000),
(20, 'Kalimantan Selatan', 52000, 48000, 51000, 54000),
(21, 'Kalimantan Utara', 57000, 50000, 54000, 60000),
(22, 'Bali', 30000, 28000, 29000, 32000),
(23, 'Nusa Tenggara Timur', 50000, 49000, 51000, 52000),
(24, 'Nusa Tenggara Barat', 39000, 38000, 40000, 41000),
(25, 'Gorontalo', 69000, 65000, 70000, 71000),
(26, 'Sulawesi Barat', 68000, 65000, 69000, 70000),
(27, 'Sulawesi Tengah', 68000, 67000, 69000, 71000),
(28, 'Sulawesi Utara', 71000, 69000, 72000, 71000),
(29, 'Sulawesi Tenggara', 70000, 70000, 71000, 720000),
(30, 'Sulawesi Selatan', 71000, 70000, 74000, 78000),
(31, 'Maluku', 72000, 70000, 76000, 77000),
(32, 'Papua Barat', 154000, 144000, 149000, 160000),
(33, 'Papua', 160000, 158000, 178000, 189000),
(34, 'Papua Selatan', 210000, 190000, 213000, 220000),
(35, 'Papua Tengah', 230000, 220000, 234000, 240000),
(36, 'Papua Pegunungan', 258000, 247000, 275000, 289000),
(37, 'Papua Barat Daya', 210000, 197000, 214000, 225000);
...
INSERT INTO `tbpengguna` (`id_pengguna`, `status`, `username`, `password`, `email`, `hp`, `prov_akun`, `kode_pos`, `alamat_akun`, `profil`, `tanggal`) VALUES
(10, 'user', 'arif', '123', 'curvast123.gmil@gmail.com', '088227883706', 'Jawa Tengah', 51255, 'Desa Blado,RT 5/RW 2, Kec. Blado, Kab. Batang', '6444e1a0306b8.jpg', '2023-03-25 16:14:22'),
(14, 'admin', 'admin9', '1234', 'iniadmin1@mymouse.com', '08652895695', 'Jawa Tengah', 42124, 'Bandung, Jl soedirman no 43', '6447a42d713c1.jpg', '2023-03-25 18:17:04'),
(16, 'user', 'filip', '123', '222@gmail.com', '088227883706', '', 0, '', 'user.jpg', '2023-03-25 19:29:37'),
(19, 'user', 'tes10', '123', 'tes@gmail.com', '088227883706', '', 0, '', 'user.jpg', '2023-04-23 13:05:54'),
(21, 'user', 'kris', '1234', 'kris@gmail.com', '0784932', '', 0, '', 'user.jpg', '2023-04-28 22:42:03'),
(22, 'user', 'kristiyan', '123', 'kristian@gmail.com', '4252432', 'Lampung', 0, '', '6451a65170a18.jpg', '2023-05-03 07:00:33'),
(23, 'admin', 'admin10', '1234', 'admin10@mymouse.com', '0883242789', 'Lampung', 0, '', 'miniLogo.png', '2023-05-03 07:13:18');
...
INSERT INTO `tbpenjualan` (`id_penjualan`, `user`, `nama`, `harga_awal`, `harga_bersih`, `harga`, `jumlah`, `catatan`, `tanggal`) VALUES
(35, 'arif', 'Taffware Mouse Bluetooth Rechargeable - M8120G', 61040, 122080, 133080, 2, 'beberapa kata tes', '2023-01-10 07:03:16'),
(36, 'admin', 'Mouse SteelSeries Rival 650 Wireless - Gaming', 1477600, 2670100, 2677100, 1, 'neymar', '2023-02-09 06:48:43'),
(37, 'admin', 'Mouse SteelSeries Rival 3 - Mouse Gaming', 499000, 2670100, 2677100, 1, 'tolong dipacking dengan rapi dan dikirim cepat ya ', '2023-03-08 06:48:43'),
(38, 'admin', 'Mouse Gaming HERO UX1', 346750, 2670100, 2677100, 2, 'dipacking dengan rapi ya', '2023-04-20 06:48:43'),
(39, 'arif', 'Mouse Gaming HERO UX1', 346750, 1642550, 1653550, 2, 'dipacking dengan rapi ya', '2023-05-03 06:56:31'),
(40, 'arif', 'ROCCAT Burst Pro Extreme Lightweight Optical Mouse Gaming', 949050, 1642550, 1653550, 1, 'dikirim hari ini ya', '2023-05-03 06:56:31'),
(41, 'filip', 'Logitech G502 HERO High Performance Gaming Mouse', 599500, 2753200, 2794200, 1, 'catatan beberapa kata tes', '2023-05-03 06:58:16'),
(42, 'filip', 'Glorious Model O Wireless Mouse Gaming', 2153700, 2753200, 2794200, 1, 'tolong dipacking dengan rapi dan dikirim cepat ya  soalnya butuh cepat nih, tes mengisi 100 karakter', '2023-06-15 07:07:40'),
(43, 'filip', 'Mouse HyperX Pulsefire RAID RGB | Ergonomic Mouse Gaming', 549600, 549600, 579600, 1, 'dipacking dengan rapi ya', '2023-05-03 06:59:44'),
(44, 'kristiyan', 'Corsair NightSword RGB FPS/MoBA Optical Mouse Gaming', 1340100, 3637700, 3707700, 1, 'tolong dipacking dengan rapi dan dikirim cepat ya ', '2023-07-14 07:02:32'),
(45, 'kristiyan', 'ROCCAT Kone EMP Mouse Gaming ROC-11-812 ', 1261600, 3637700, 3707700, 1, 'dipacking dengan rapi ya', '2023-08-31 07:02:32'),
(46, 'kristiyan', 'Razer Viper Ultimate Hyper speed Wireless Gaming Mouse', 1036000, 3637700, 3707700, 1, 'catatan beberapa kata tes', '2023-09-10 07:02:35'),
(47, 'kristiyan', 'Glorious Model O Wireless Mouse Gaming', 4307400, 4585500, 4619500, 2, 'dipacking dengan rapi ya', '2023-10-19 07:11:36'),
(48, 'kristiyan', 'Logitech M350 Wireless Silent Mouse Logitech', 278100, 4585500, 4619500, 1, ' beberapa kata tes', '2023-11-30 07:11:36'),
(49, 'admin10', 'Logitech M350 Wireless Silent Mouse Logitech', 834300, 1016380, 1086380, 3, 'dipacking dengan rapi ya', '2023-12-21 07:15:41'),
(50, 'admin10', 'Mouse Wireless ROBOT M205 2.4G 1600DPI', 120000, 1016380, 1086380, 1, 'dikirim hari ini ya', '2023-05-03 07:15:41'),
(51, 'admin10', 'Taffware Mouse Bluetooth Rechargeable - M8120G', 122080, 1016380, 1086380, 2, ' beberapa kata tes', '2023-05-03 07:15:41'),
(52, 'admin10', 'Mouse Gaming RAZER Viper Ambidextrous Esports', 1954800, 1954800, 1978800, 2, 'dikirim hari ini ya', '2023-05-03 07:27:48'),
(53, 'admin', 'Mouse SteelSeries Rival 650 Wireless - Gaming', 1477600, 1605400, 1616400, 1, 'tolong dipacking dengan rapi dan dikirim cepat ya ', '2023-05-03 09:06:08'),
(54, 'admin', 'Mouse Gaming Rexus Xierra X8 RGB - Body Ergonomis ', 127800, 1605400, 1616400, 1, 'tolong dipacking dengan rapi dan dikirim cepat ya ', '2023-05-03 09:06:08');
...
INSERT INTO `tbpesanan` (`id_pesan`, `user`, `nama`, `harga_awal`, `harga`, `totalHar`, `jumlah`, `warna`, `catatan`, `gambar`, `alamat`, `pos`, `hp`, `Hkurir`, `Pembayaran`, `tanggal`) VALUES
(106, 'arif', 'Mouse SteelSeries Rival 3 - Mouse Gaming', 499000, 1127200, 1134200, 2, 'Hitam', 'tolong dipacking dengan rapi dan dikirim cepat ya  soalnya butuh cepat nih, tes mengisi 100 karakter', 'brand (10).jpg', 'Jawa Tengah, Desa Blado,RT 5/RW 2, Kec. Blado, Kab. Batang', '51255', '088227883706', 'POS Indonesia Rp7.000', 'Dana(dcQ2qxy11T)', '2023-05-03 06:55:12'),
(107, 'arif', 'Mouse Gaming Rexus Xierra G10 Mouse Gaming', 129200, 1127200, 1134200, 1, 'Hitam', 'dipacking dengan rapi ya', '64513f444ee69.jpg', 'Jawa Tengah, Desa Blado,RT 5/RW 2, Kec. Blado, Kab. Batang', '51255', '088227883706', 'POS Indonesia Rp7.000', 'Dana(dcQ2qxy11T)', '2023-05-03 06:55:12'),
(122, 'admin', 'Mouse SteelSeries Rival 3 - Mouse Gaming', 499000, 1740100, 1747100, 1, 'Putih', 'tolong dipacking dengan rapi dan dikirim cepat ya  soalnya butuh cepat nih, tes mengisi 100 karakter', 'brand (10).jpg', 'Jawa Tengah, Bandung, Jl soedirman no 43', '42124', '08652895695', 'POS Indonesia Rp7.000', 'Dana(HR8QEywZuK)', '2023-05-03 09:10:06'),
(123, 'admin', 'Glorious Model D Wireless Mouse Gaming', 2482200, 1740100, 1747100, 1, 'Putih', 'tolong dipacking dengan rapi dan dikirim cepat ya  soalnya butuh cepat nih, tes mengisi 100 karakter', '64514080e307c.jpg', 'Jawa Tengah, Bandung, Jl soedirman no 43', '42124', '08652895695', 'POS Indonesia Rp7.000', 'Dana(HR8QEywZuK)', '2023-05-03 09:10:06');
...
INSERT INTO `tbproduk` (`id_produk`, `brand`, `nama`, `harga`, `diskon`, `terdiskon`, `jenis`, `gambar`, `gambar2`, `gambar3`, `gambar4`, `stok`, `terjual`, `deskripsi`, `tanggal`) VALUES
...
--
ALTER TABLE `tbkeranjang`
  MODIFY `id_keranjang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=866;

--
-- AUTO_INCREMENT for table `tbkurir`
--
ALTER TABLE `tbkurir`
  MODIFY `id_kurir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `tbpenjualan`
  MODIFY `id_penjualan` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
